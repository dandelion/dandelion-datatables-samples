...
<div class="row-fluid">
   <div class="span12">
      ...
      <datatables:table id="myTableId" url="/ajax/persons" serverSide="true" dom="l0rtip" filterSelector="#filterButton" filterClearSelector="#filterClearButton" cssClass="display">
         ...
         <datatables:column title="City" property="address.town.name" filterable="true" filterCssClass="input-medium" />
         <datatables:column title="Mail" property="mail" renderFunction="app-custom-rendering#mailify" />
         <datatables:column title="Company" property="company.name" filterable="true" filterType="select" filterValues="app-filtering#predefinedValues" />
